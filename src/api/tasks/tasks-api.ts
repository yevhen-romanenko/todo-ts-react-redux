...
const apiTasksStore: any = {
    tasks: [
        ...
        },
        {
            ...
            description: 'Add and implement reusable componnet button for AddCard and AddList ',
        ...
        },
        {
            ...
            description: 'rewrite your TODO APP to new structure looks like as example ',
            dateOfCreate: '2021/10/18 13:17',
            expiredDate: '2021/10/28 13:17',
        },
        {
            ...
            description: 'Try to add API to your project and work with middlewares (redux-thunk)',
            dateOfCreate: '2021-10-18 12:44',
            expiredDate: '2021/10/18 13:17',
        },
    ],
...
export const deleteTaskReq = (id: number) => {
    const newTaskStore = apiTasksStore.tasks.filter((task: any) => task.id !== id);
...
export const addTaskReq = (columnID: number, titleData: string, descriptionData: string, expiredDateData: string) => {
    const newTask = {
