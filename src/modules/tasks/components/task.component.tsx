...
import { TaskHeaderIsExpired, TaskDateLabels, TaskDateExpiredLabels } from '../atoms';
...
export const TodoTask: FC<IProps> = ({ id, columnID, title, description, dateOfCreate, expiredTaskDate }) => {
